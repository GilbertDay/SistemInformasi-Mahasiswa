    ...
    <div class="col">
        <div class="card py-2" style="background-color:rgb(27, 18, 41)">
            <div class="card-header" style="background-color:rgb(63, 45, 93)">
                <a name="" id=""  class="btn btn-outline-primary float-right" href="/mahasiswa/formmahasiswa" role="button"><i class="bi bi-person-plus-fill"></i>Tambah</a>
                <form class="input-group w-50 float-left" method="GET" action="/mahasiswa/cari">
                          ...
                          <td>
                            <div class="btn-group dropleft">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <a class="dropdown-item" href="/mahasiswa/editmahasiswa/{{ $m -> id}}" type="button" style="word-spacing:50px">
                                  Edit <i class="bi bi-pencil-square"></i>
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/mahasiswa/hapusmahasiswa/{{ $m -> id}}" type="button"
